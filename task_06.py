"""
Наступне завдання буде суто теоретичним, 
і ми потренуємося працювати з довільною кількістю аргументів.
...
def second(size, **kvargs):
    print(kvargs)
    lengths = size + len(kvargs)
    return lengths


print(second(1, comment_two="second", comment_third="third", comment_one="first"))
